locals {
  ...
  name_from_descriptor = trim(replace(
    lookup(module.this.descriptors, "azure-key-vault", module.this.id),
    "/${module.this.delimiter}${module.this.delimiter}+/",
  module.this.delimiter), module.this.delimiter)

  private_link_name_from_descriptor = trim(replace(
    lookup(module.this.descriptors, "azure-private-link", module.this.id),
    "/${module.this.delimiter}${module.this.delimiter}+/",
  module.this.delimiter), module.this.delimiter)
